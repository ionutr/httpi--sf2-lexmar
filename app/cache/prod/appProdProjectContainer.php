...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/assetic/config'), false)));
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'maritime', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_06b397f78a22f53294a96bed5368501c');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_06b397f78a22f53294a96bed5368501c');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_06b397f78a22f53294a96bed5368501c');
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\src\\Httpi\\Maritime\\Bundle\\ImportBundle\\Resources\\config\\doctrine' => 'Httpi\\Maritime\\Bundle\\ImportBundle\\Entity'));
        $d->setGlobalBasename('mapping');
        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Httpi\\Maritime\\Bundle\\ImportBundle\\Entity');
        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('HttpiMaritimeImportBundle' => 'Httpi\\Maritime\\Bundle\\ImportBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\src\\Httpi\\Maritime\\Bundle\\AdminBundle/Resources/views', 'HttpiMaritimeAdmin');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod',
            ...
            'session.save_path' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/prod/doctrine/orm/Proxies',
