...
\t";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "3136dac_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_3136dac_0") : $this->env->getExtension('assets')->getAssetUrl("css/3136dac_apydatagrid_1.css");
            // line 6
    ...
    ";
            ...
            // asset "3136dac"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_3136dac") : $this->env->getExtension('assets')->getAssetUrl("css/3136dac.css");
            echo "\t<link rel=\"stylesheet\" href=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\" />
    ";
