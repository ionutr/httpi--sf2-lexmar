...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'maritime', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_f5ee6a161e299663d8246df7764f98d3');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f5ee6a161e299663d8246df7764f98d3');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f5ee6a161e299663d8246df7764f98d3');
        ...
        $d->setProxyDir('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/logs/test.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\src\\Httpi\\Maritime\\Bundle\\ImportBundle/Resources/views', 'HttpiMaritimeImport');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/Resources/views');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test',
            'kernel.logs_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/logs',
            ...
            'debug.container.dump' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Work\\vhosts\\httpi\\maritime terms encyclopedia\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/assetic',
            ...
            'assetic.read_from' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/../web',
            'assetic.write_to' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Work/vhosts/httpi/maritime terms encyclopedia/trunk/app/cache/test/doctrine/orm/Proxies',
