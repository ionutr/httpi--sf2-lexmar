...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'httpi_core.fileupload' => 'getHttpiCore_FileuploadService',
            ...
            'oneup_uploader.validation_listener.allowed_extension' => 'getOneupUploader_ValidationListener_AllowedExtensionService',
            'oneup_uploader.validation_listener.allowed_mimetype' => 'getOneupUploader_ValidationListener_AllowedMimetypeService',
            'oneup_uploader.validation_listener.disallowed_extension' => 'getOneupUploader_ValidationListener_DisallowedExtensionService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HttpiCoreBundle', 'C:/Work/vhosts/httpi/lexmar/trunk/app/Resources/HttpiCoreBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HttpiCoreBundle', 'C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Bundle\\CoreBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HttpiMaritimeAdminBundle', 'C:/Work/vhosts/httpi/lexmar/trunk/app/Resources/HttpiMaritimeAdminBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HttpiMaritimeAdminBundle', 'C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Maritime\\Bundle\\AdminBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', 'C:/Work/vhosts/httpi/lexmar/trunk/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Work/vhosts/httpi/lexmar/trunk/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'lexmar', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_d99ae3d6dcea74d18fe2cea9ebdef2f5');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d99ae3d6dcea74d18fe2cea9ebdef2f5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d99ae3d6dcea74d18fe2cea9ebdef2f5');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Maritime\\Bundle\\CoreBundle\\Resources\\config\\doctrine' => 'Httpi\\Maritime\\Bundle\\CoreBundle\\Entity', 'C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Bundle\\CoreBundle\\Resources\\config\\doctrine' => 'Httpi\\Bundle\\CoreBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Httpi\\Maritime\\Bundle\\CoreBundle\\Entity');
        $e->addDriver($d, 'Httpi\\Bundle\\CoreBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('HttpiMaritimeCoreBundle' => 'Httpi\\Maritime\\Bundle\\CoreBundle\\Entity', 'HttpiCoreBundle' => 'Httpi\\Bundle\\CoreBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('oneup_uploader.validation', array(0 => 'oneup_uploader.validation_listener.allowed_extension', 1 => 'onValidate'), 0);
        $instance->addListenerService('oneup_uploader.validation', array(0 => 'oneup_uploader.validation_listener.disallowed_extension', 1 => 'onValidate'), 0);
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Work/vhosts/httpi/lexmar/trunk/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'a1eae23b5ddf7a76faf5dd09e7dffba4');
    }
    ...
    /**
     * Gets the 'httpi_core.fileupload' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Httpi\Bundle\CoreBundle\Library\File\FileUpload A Httpi\Bundle\CoreBundle\Library\File\FileUpload instance.
     */
    protected function getHttpiCore_FileuploadService()
    {
        return $this->services['httpi_core.fileupload'] = new \Httpi\Bundle\CoreBundle\Library\File\FileUpload($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Work/vhosts/httpi/lexmar/trunk/app/logs/dev.log', 100, true);
    }
    ...
    {
        return $this->services['oneup_uploader.chunk_manager'] = new \Oneup\UploaderBundle\Uploader\Chunk\ChunkManager(array('maxage' => 604800, 'directory' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/uploader/chunks', 'load_distribution' => true));
    }
    ...
    protected function getOneupUploader_Controller_GalleryService()
    {
        ...
        return $this->services['oneup_uploader.controller.gallery'] = $this->scopedServices['request']['oneup_uploader.controller.gallery'] = new \Oneup\UploaderBundle\Controller\DropzoneController($this, $this->get('oneup_uploader.storage.gallery'), $this->get('oneup_uploader.error_handler.dropzone'), array('frontend' => 'dropzone', 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'storage' => array('service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'directory' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/../web/uploads/gallery', 'sync_buffer_size' => '100K'), 'allowed_extensions' => array(), 'disallowed_extensions' => array(), 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 2147483647, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid'), 'gallery');
    }
    ...
    {
        return $this->services['oneup_uploader.orphanage_manager'] = new \Oneup\UploaderBundle\Uploader\Orphanage\OrphanageManager($this, array('maxage' => 604800, 'directory' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/uploader/orphanage'));
    }
    ...
    {
        return $this->services['oneup_uploader.storage.gallery'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage('C:/Work/vhosts/httpi/lexmar/trunk/app/../web/uploads/gallery');
    }
    ...
    /**
     * Gets the 'oneup_uploader.validation_listener.allowed_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Oneup\UploaderBundle\EventListener\AllowedExtensionValidationListener A Oneup\UploaderBundle\EventListener\AllowedExtensionValidationListener instance.
     */
    protected function getOneupUploader_ValidationListener_AllowedExtensionService()
    {
        return $this->services['oneup_uploader.validation_listener.allowed_extension'] = new \Oneup\UploaderBundle\EventListener\AllowedExtensionValidationListener();
    }
    ...
    /**
     * Gets the 'oneup_uploader.validation_listener.disallowed_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Oneup\UploaderBundle\EventListener\DisallowedExtensionValidationListener A Oneup\UploaderBundle\EventListener\DisallowedExtensionValidationListener instance.
     */
    protected function getOneupUploader_ValidationListener_DisallowedExtensionService()
    {
        return $this->services['oneup_uploader.validation_listener.disallowed_extension'] = new \Oneup\UploaderBundle\EventListener\DisallowedExtensionValidationListener();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Work/vhosts/httpi/lexmar/trunk/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Work/vhosts/httpi/lexmar/trunk/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Work/vhosts/httpi/lexmar/trunk/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'HttpiCoreBundle', 1 => 'HttpiMaritimeAdminBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Maritime\\Bundle\\ImportBundle/Resources/views', 'HttpiMaritimeImport');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Maritime\\Bundle\\AdminBundle/Resources/views', 'HttpiMaritimeAdmin');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\apy\\datagrid-bundle\\APY\\DataGridBundle/Resources/views', 'APYDataGrid');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Maritime\\Bundle\\CoreBundle/Resources/views', 'HttpiMaritimeCore');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Bundle\\CoreBundle/Resources/views', 'HttpiCore');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Work/vhosts/httpi/lexmar/trunk/app/Resources/views');
        $instance->addPath('C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a1eae23b5ddf7a76faf5dd09e7dffba4');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Work/vhosts/httpi/lexmar/trunk/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => 'C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Maritime\\Bundle\\AdminBundle\\Resources\\config\\validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Work/vhosts/httpi/lexmar/trunk/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev',
            'kernel.logs_dir' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/logs',
            'kernel.bundles' => array(
                ...
                'HttpiMaritimeImportBundle' => 'Httpi\\Maritime\\Bundle\\ImportBundle\\HttpiMaritimeImportBundle',
                'HttpiMaritimeAdminBundle' => 'Httpi\\Maritime\\Bundle\\AdminBundle\\HttpiMaritimeAdminBundle',
                'APYDataGridBundle' => 'APY\\DataGridBundle\\APYDataGridBundle',
                'OneupUploaderBundle' => 'Oneup\\UploaderBundle\\OneupUploaderBundle',
                'HttpiMaritimeCoreBundle' => 'Httpi\\Maritime\\Bundle\\CoreBundle\\HttpiMaritimeCoreBundle',
                'HttpiCoreBundle' => 'Httpi\\Bundle\\CoreBundle\\HttpiCoreBundle',
            ...
            'locale' => 'en',
            'secret' => 'a1eae23b5ddf7a76faf5dd09e7dffba4',
            ...
            'debug.container.dump' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'a1eae23b5ddf7a76faf5dd09e7dffba4',
            ...
            'session.save_path' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'C:\\Work\\vhosts\\httpi\\lexmar\\trunk\\src\\Httpi\\Maritime\\Bundle\\AdminBundle\\Resources\\config\\validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/assetic',
            'assetic.bundles' => array(
                0 => 'HttpiCoreBundle',
                1 => 'HttpiMaritimeAdminBundle',
            ),
            ...
            'assetic.read_from' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/../web',
            'assetic.write_to' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/doctrine/orm/Proxies',
            'doctrine.orm.proxy_namespace' => 'Proxies',
            'doctrine_migrations.dir_name' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/DoctrineMigrations',
            ...
            'oneup_uploader.orphanage.class' => 'Oneup\\UploaderBundle\\Uploader\\Storage\\OrphanageStorage',
            ...
            'oneup_uploader.chunks' => array(
                'maxage' => 604800,
                'directory' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/uploader/chunks',
                'load_distribution' => true,
            ),
            'oneup_uploader.orphanage' => array(
                'maxage' => 604800,
                'directory' => 'C:/Work/vhosts/httpi/lexmar/trunk/app/cache/dev/uploader/orphanage',
            ),
            ...
            'custombundles' => array(
                0 => 'HttpiCoreBundle',
                1 => 'HttpiMaritimeCoreBundle',
                2 => 'HttpiMaritimeAdminBundle',
                3 => 'HttpiMaritimeImportBundle',
            ),
